...
class Weixin_QYAPI_Crypt_WXBizMsgCrypt {
    ...
    public function VerifyURL($sMsgSignature, $sTimeStamp, $sNonce, $sEchoStr, &$sReplyEchoStr) {
        if (strlen($this->m_sEncodingAesKey) != 43) {
            return Weixin_QYAPI_Crypt_ErrorCode::$IllegalAesKey;
        }

        $pc = new Weixin_QYAPI_Crypt_Prpcrypt($this->m_sEncodingAesKey);
        //verify msg_signature
        $sha1 = new Weixin_QYAPI_Crypt_SHA1;
        ...
        if ($signature != $sMsgSignature) {
            return Weixin_QYAPI_Crypt_ErrorCode::$ValidateSignatureError;
        }
        ...
        return Weixin_QYAPI_Crypt_ErrorCode::$OK;
    }
    ...
    public function EncryptMsg($sReplyMsg, $sTimeStamp, $sNonce, &$sEncryptMsg) {
        ...
        //生成发送的xml
        $xmlparse = new Weixin_QYAPI_Crypt_XMLParse;
